...
import { initialUserProfile } from '@/lib/mock-data'; // Using this as a template
...
export default function SelectProfilePage() {
  ...
  const handleDelete = (profileId: number) => {
    ...
    // In a real app, this would remove the profile from the list
  };
    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-background text-foreground p-8">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <button className="group w-48 h-64 rounded-2xl border-2 border-dashed border-muted-foreground/50 flex flex-col items-center justify-center text-muted-foreground/80 hover:border-primary hover:text-primary transition-all duration-300 aura-pulse-border focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background">
