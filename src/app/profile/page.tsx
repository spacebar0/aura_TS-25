...
export default function ProfilePage() {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-500 pt-24">
      ...
      <section>
        <h2 className="text-3xl font-headline mb-6">Trophy Case</h2>
