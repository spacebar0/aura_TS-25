...
export function LibraryCard({ className }: { className?: string }) {
  return (
    <Link href="/library" className="block w-60 h-full">
      <Card
        className={cn(
          'group relative aspect-[3/4] w-full h-full overflow-hidden rounded-lg transition-all duration-300 ease-in-out',
